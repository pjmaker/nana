...
pkgdatadir = $(datadir)/nana
pkglibdir = $(libdir)/nana
pkgincludedir = $(includedir)/nana
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_alias = i386-unknown-freebsd5.3
build_triplet = i386-unknown-freebsd5.3
host_alias = i386-unknown-freebsd5.3
host_triplet = i386-unknown-freebsd5.3
target_alias = i386-unknown-freebsd5.3
target_triplet = i386-unknown-freebsd5.3
CC = gcc
CXX = c++
CXXCPP = c++ -E
FIND = find
...
EXTRA_DIST = TODO REGISTRATION aclocal.m4 ANNOUNCE INSTALL.con 		showconfig.c PROJECTS


AWK = gawk
CPP = gcc -E
TAR = /usr/bin/gtar
DEFS =  -DPACKAGE=\"nana\" -DVERSION=\"2.5\" -DHAVE_VSPRINTF=1 -DHAVE_VSNPRINTF=1 -DHAVE_GETTIMEOFDAY=1 
...
CONFIG_CLEAN_FILES =  gnuware
DIST_COMMON =  README AUTHORS COPYING ChangeLog INSTALL Makefile.am \
Makefile.in NEWS THANKS TODO acinclude.m4 aclocal.m4 config.guess \
config.sub configure configure.in gnuware.in install-sh missing \
mkinstalldirs
...
$(srcdir)/configure: $(srcdir)/configure.in $(ACLOCAL_M4) $(CONFIGURE_DEPENDENCIES)
	cd $(srcdir) && $(AUTOCONF)
gnuware: $(top_builddir)/config.status gnuware.in
